...
namespace Subtitle
{
    public class Subtitle : Mod
    {
        ...
        public override void OnLoad()
        {
            ...
            GameObject ShadowObject = GameObject.Find("Shadow");
        ...
        public override void OnGUI()
        {
            ...
            if (text1b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text1 + "\n" +"不要偷懒。快去修理你爸爸的旧车，" + "\n" + "叔叔的蓝色小货车可以借给你。不要喝酒，当我们玩到无聊之后， 我们会回来的 。你的爸爸妈妈.", myStyle);
            }

            text2 = "\"" + "Hello! I would like to buy a flatbed load of firewoods. You can deliver them any time!" + "\" ";
            if (text2b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text2 + "\n" +text2 + "\n" +"我想买一车劈好的木柴。你可以随时送货过来！", myStyle);
            }

            text3 = "\"" + "Our sewage well is full of crap. Come and empty it." + "\"";
            if (text3b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text3 + "\n" +"我的污水井已经满了。来把它抽空。", myStyle);
            }

            text4 = "\"" + "My dad asked me to call about the sewage well, it is full. He is drunk." + "\"";
            if (text4b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text4 + "\n" +"我爸爸叫我打电话给有关污水井，已经满了。他喝醉了", myStyle);
            }

            text5 = "\"" + "Hi! Our shit is full of crap... sewage well. You should come here and suck it..." + "\"";
            if (text5b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text5 + "\n" +"你好！我们的屎满出来了…污水井。你应该来这里抽光它…", myStyle);
            }

            text6 = "\"" + "How could I say... Our sewage well is completely full... Could you empty it?" + "\"";
            if (text6b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text6 + "\n" +"我怎么能说…我们的污水井已经完全填满了。你能把它清空吗？", myStyle);
            }

            text7 = "\"" + "Could you suck our sewage well dry? I pay of course!" + "\"";
            if (text7b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text7 + "\n" +"你能把我们的污水干好吗？当然，我付钱！", myStyle);
            }

            text8 = "\"" + "Fleetari here! Your repair work is ready. Come here and get your stuff." + "\"";
            if (text8b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text8 + "\n" +"Fleetari这里！你的修理工作已经完成了。过来拿你的东西。", myStyle);
            }

            text9 = "\"" + "Your post order has arrived. You can pick it up from the store." + "\"";
            if (text9b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text9 + "\n" +"你的邮购已经到了。你可以从商店里付款收件了。", myStyle);
            }

            text10 = "\"" + "Good morning and welcome to Rindell Car Inspection." + "\"";
            if (text10b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text10 + "\n" +"早上好，欢迎光临Rindell Car Inspection.", myStyle);
            }

            text11 = "\"" + "Not sure what happened, your car passed." + "\"";
            if (text11b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text11 + "\n" +"不知道发生了什么事，你的车通过了。", myStyle);
            }

            text12 = "\"" + "There is no way this is going to pass. But more money for me." + "\"";
            if (text12b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text12 + "\n" +"这是不可能实现的。除非你给我更多的钱。", myStyle);
            }

            text13 = "\"" + "I don't know what to say. My life and my job sucks." + "\"";
            if (text13b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text13 + "\n" +"我不知道说什么好。我的生活和工作糟透了。", myStyle);
            }

            text14 = "\"" + "Do not even bother to fix this. This car is ready for scrapping." + "\"";
            if (text14b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text14 + "\n" +"不用费心去修理它。这辆车准备报废了。", myStyle);
            }

            text15 = "\"" + "You are such a character with this car of yours." + "\"";
            if (text15b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text15 + "\n" +"你真是一个拥有你这辆车的人。", myStyle);
            }

            text16 = "\"" + "I am not getting neither baby chickens or eggs." + "\"";
            if (text16b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text16 + "\n" +"我既没有鸡宝宝也没有鸡蛋。", myStyle);
            }

            text17 = "\"" + "Satan..." + "\"";
            if (text17b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text17 + "\n" +"撒旦...", myStyle);
            }

            text18 = "\"" + "God help me." + "\"";
            if (text18b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text18 + "\n" +"上帝保佑。", myStyle);
            }

            text19 = "\"" + "Oh pussy again..." + "\"";
            if (text19b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text19 + "\n" +"哦，又是这脓样的", myStyle);
            }

            text20 = "\"" + "Satan again." + "\"";
            if (text20b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text20 + "\n" +"撒旦再临.", myStyle);
            }

            text21 = "\"" + "Not the satan." + "\"";
            if (text21b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text21 + "\n" +"不是这个撒旦。", myStyle);
            }

            text22 = "\"" + "Pussy." + "\"";
            if (text22b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text22 + "\n" +"脓样的.", myStyle);
            }

            text23 = "\"" + "Go to pussy, satan." + "\"";
            if (text23b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text23 + "\n" +"去你脓样的, 撒旦.", myStyle);
            }

            text24 = "\"" + "Go to pussy, please." + "\"";
            if (text24b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text24 + "\n" +"请去你脓样的", myStyle);
            }

            text25 = "\"" + "You dork of the pussy." + "\"";
            if (text25b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text25 + "\n" +"你个傻脓样的.", myStyle);
            }

            text26 = "\"" + "You, go home." + "\"";
            if (text26b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text26 + "\n" +"你，回家.", myStyle);
            }

            text27 = "\"" + "Go to hell." + "\"";
            if (text27b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text27 + "\n" +"下地狱", myStyle);
            }

            text28 = "\"" + "Smell a pussy!" + "\"";
            if (text28b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text28 + "\n" +"我闻到一个脓样的", myStyle);
            }

            text29 = "\"" + "Oh pussy!" + "\"";
            if (text29b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text29 + "\n" +"奥，脓样的!", myStyle);
            }

            text30 = "\"" + "Oh satan!" + "\"";
            if (text30b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text30 + "\n" +"奥, 撒旦!", myStyle);
            }

            text31 = "\"" + "One spring of pussies!" + "\"";
            if (text31b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text31 + "\n" +"一个春天!", myStyle);
            }

            text32 = "\"" + "What the hell!?" + "\"";
            if (text32b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text32 + "\n" +"我勒个去!?", myStyle);
            }

            text33 = "\"" + "Satan?" + "\"";
            if (text33b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text33 + "\n" +"撒旦?", myStyle);
            }

            text34 = "\"" + "It is the spring of pussies for sure!" + "\"";
            if (text34b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text34 + "\n" +"肯定是春天（发春？）来了。!", myStyle);
            }

            text35 = "\"" + "Oh hell, for real!" + "\"";
            if (text35b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text35 + "\n" +"奥，真是地狱啊!", myStyle);
            }

            text36 = "\"" + "The pussy of all pussies!" + "\"";
            if (text36b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text36 + "\n" +"所有的娘娘腔!", myStyle);
            }

            text37 = "\"" + "God of thunder!" + "\"";
            if (text37b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text37 + "\n" +"雷神!", myStyle);
            }

            text38 = "\"" + "God help me already!" + "\"";
            if (text38b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text38 + "\n" +"上帝已经帮助我了！", myStyle);
            }

            text39 = "\"" + "There is no blood in my alcohol, much." + "\"";
            if (text39b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text39 + "\n" +"我的酒里没有血。", myStyle);
            }

            text40 = "\"" + "I used to be sober and I walked next to the fields." + "\"";
            if (text40b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text40 + "\n" +"我过去是清醒的，我走在田野旁边。", myStyle);
            }

            text41 = "\"" + "I haven't drank... enough... yet." + "\"";
            if (text41b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text41 + "\n" +"我还没喝过…够了…然而。", myStyle);
            }

            text42 = "\"" + "It is easy to be drunk. No stress from life and being sober." + "\"";
            if (text42b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text42 + "\n" +"喝醉是很容易的。没有生活的压力和清醒。", myStyle);
            }

            text43 = "\"" + "I haven't drank anything, and I won't." + "\"";
            if (text43b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text43 + "\n" +"我什么都没喝，也不会喝。", myStyle);
            }

            text44 = "\"" + "Andy of the large house and the Shore of lake... blrb... braah..." + "\"";
            if (text44b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text44 + "\n" +"安迪的大房子和湖的岸边…BRRB…布拉…", myStyle);
            }

            text45 = "\"" + "Let's take it easy." + "\"";
            if (text45b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text45 + "\n" +"让我们轻松一下.", myStyle);
            }

            text46 = "\"" + "We are taking it hard at all." + "\"";
            if (text46b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text46 + "\n" +"我们完全是硬的.", myStyle);
            }

            text47 = "\"" + "Feels good, yes, for sure." + "\"";
            if (text47b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text47 + "\n" +"感觉很好，是的，当然.", myStyle);
            }

            text48 = "\"" + "I am drunk as satan, but doesn't matter!" + "\"";
            if (text48b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text48 + "\n" +"我喝醉了撒旦，但不要紧！", myStyle);
            }

            text49 = "\""+"Good lady-mister, I haven't drank at all, and I won't. When I am sober."+"\"";
            if(text49b)
            {
                GUI.Label(new Rect(0, (Screen.height)/2.35f, Screen.width, Screen.height), text49 + "\n" +"亲爱的先生”，我一点都不喝，我也不喝。当我清醒的时候。", myStyle);
            }

            text50 = "\"" + "Hello! Are you a fly or a bird?" + "\"";
            if (text50b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text50 + "\n" +"你好！你是一只苍蝇还是一只鸟？", myStyle);
            }

            text51 = "\"" + "Andy of the large house and the Shore of lake!" + "\"";
            if (text51b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text51 + "\n" +"安迪的大房子和湖滨！", myStyle);
            }

            text52 = "\"" + "Well. Looks like it's finished. Take the money." + "\"";
            if (text52b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text52 + "\n" +"嗯。看起来已经结束了。拿钱。", myStyle);
            }

            text53 = "\"" + "Thank you very much, you've deserved your money." + "\"";
            if (text53b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text53 + "\n" +"非常谢谢你，你应该得到你的钱。", myStyle);
            }

            text54 = "\"" + "I am very happy with your work. I couldn't do any better." + "\"";
            if (text54b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text54 + "\n" +"我对你的工作很满意。换我来的话我没办法做这么好。", myStyle);
            }

            text55 = "\"" + "Thank you. I am very happy with this, here is your money." + "\"";
            if (text55b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text55 + "\n" +"谢谢。我对此感到很高兴，这是你的钱。", myStyle);
            }

            text56 = "\"" + "Just take the money and let's continue with our lives." + "\"";
            if (text56b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text56 + "\n" +"拿着钱，让我们继续我们的生活", myStyle);
            }

            text57 = "\"" + "No money, no rally participation for you." + "\"";
            if (text57b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text57 + "\n" +"没有钱，没有集会参与为你。", myStyle);
            }

            text58 = "\"" + "You are required to wear a crash helmet." + "\"";
            if (text58b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text58 + "\n" +"你必须戴上头盔。", myStyle);
            }

            text59 = "\"" + "Your car is missing required safety gear." + "\"";
            if (text59b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text59 + "\n" +"你的汽车缺少所需的安全装置。", myStyle);
            }

            text60 = "\"" + "Your car needs to be inspected and registered." + "\"";
            if (text60b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text60 + "\n" +"你的车需要通过检查并挂牌。", myStyle);
            }

            text61 = "\"" + "You are drunk. Go home." + "\"";
            if (text61b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text61 + "\n" +"你喝醉了。回家", myStyle);
            }

            text62 = "\"" + "Hello! What is on your mind young man?" + "\"";
            if (text62b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text62 + "\n" +"你好”！年轻人，你在想什么？", myStyle);
            }
            ...
            if (text64b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text64 + "\n" +"当你有钱的时候再来”", myStyle);
            }

            text65 = "\"" + "Why do you even come here if you don't have any money?" + "\"";
            if (text65b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text65 + "\n" +"如果你没有钱，你为什么还要来这里？", myStyle);
            }
            ...
            if (text67b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text67 + "\n" +"这里是FrelaLi！你这个笨蛋，把我的车拿回来，不然我肯定你再也见不到你的车了！", myStyle);
            }

            text68 = "\"" + "What a great junk find! Thanks boy. Here is some money for it." + "\"";
            if (text68b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text68 + "\n" +"一个伟大的垃圾（废车？）找到！谢谢孩子。这里有一些钱。", myStyle);
            }
            ...
            if (text69b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text69 + "\n" +"我不敢相信…你是拉力赛冠军。我必须承认你有这么大的能耐。我以为你要输了，但你赢了！", myStyle);
            }
            ...
            if (text71b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text71 + "\n" +"哦，孩子，我听到你做了什么！这是十瓶酒，你真的配得上这个！", myStyle);
            }

            text72 = "\"" + "My neighbor is a dick." + "\"";
            if (text72b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text72 + "\n" +"我的邻居是个混蛋", myStyle);
            }

            text73 = "\"" + "You dick of a pussy." + "\"";
            if (text73b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text73 + "\n" +"你这个混蛋脓样", myStyle);
            }

            text74 = "\"" + "You truly are a wart of a dick." + "\"";
            if (text74b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text74 + "\n" +"你真是个恶棍", myStyle);
            }

            text75 = "\"" + "Stop walking around like a damn fool. You do not make any sense, ruining my perfect day." + "\"";
            if (text75b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text75 + "\n" +"别像一个该死的傻瓜一样走来走去。你这么做没有任何意义，还毁掉了我完美的一天。", myStyle);
            }

            text76 = "\"" + "So the signs are in the air? You know, someone is going to get hurt soon." + "\"";
            if (text76b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text76 + "\n" +"那么看这迹象？你知道，有人很快就会受伤", myStyle);
            }

            text77 = "\"" + "Let me see that finger one more time and I will smash your head." + "\"";
            if (text77b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text77 + "\n" +"让我再看一次手指，我会砸碎你的头。", myStyle);
            }

            text78 = "\"" + "What the fuck? Come here and show me that finger of yours." + "\"";
            if (text78b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text78 + "\n" +"他妈的什么？过来，给我看看你的手指。", myStyle);
            }

            text79 = "\"" + "Who is this pussy-ass idiot?" + "\"";
            if (text79b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text79 + "\n" +"这个笨蛋蠢驴是谁？", myStyle);
            }

            text80 = "\"" + "So you want that I make a dinner out from your finger? And shove it down to your throat?" + "\"";
            if (text80b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text80 + "\n" +"所以你要我用你的手指做晚餐？把它推到你的喉咙里？", myStyle);
            }

            text81 = "\"" + "Stop fooling around or I will smash your head and hard!" + "\"";
            if (text81b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text81 + "\n" +"别胡闹了，否则我会砸烂你的脑袋！", myStyle);
            }

            text82 = "\"" + "God of Thunder! You are so dead!" + "\"";
            if (text82b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text82 + "\n" +"雷神”！你死定了！", myStyle);
            }

            text83 = "\"" + "So you would like to race with that shit bucket of yours? Which one is faster?" + "\"";
            if (text83b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text83 + "\n" +"所以你想与你的狗屎比赛吗？哪一个更快？", myStyle);
            }

            text84 = "\"" + "What is that piss you're drinking? Like drinking from a wc bowl. You should drink Kurjala beer!" + "\" ";
            if (text84b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text84 + "\n" +"你喝的尿是什么？就像从WC碗里喝水一样。你应该喝库拉拉啤酒！", myStyle);
            }

            text85 = "\"" + "Is Teimo selling you that shit? He should sell some Kurjala instead. Everything is just shit." + "\"";
            if (text85b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text85 + "\n" +"是Teimo卖给你那狗屎吗？他应该卖掉一些库尔亚拉。一切都是狗屎。", myStyle);
            }

            text86 = "\"" + "Fuck you, no one is drinking that shit. Just throw it away, you little shit." + "\"";
            if (text86b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text86 + "\n" +"操，没有人在喝那狗屎。扔掉它，你这个小狗屎。", myStyle);
            }

            text87 = "\"" + "I don't have energy to watch your face." + "\"";
            if (text87b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text87 + "\n" +"我没有精力去看你的脸。", myStyle);
            }

            text88 = "\"" + "You dick of a pussy!" + "\"";
            if (text88b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text88 + "\n" +"你这个脓样的混蛋！", myStyle);
            }

            text89 = "\"" + "Smell a shit!" + "\"";
            if (text89b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text89 + "\n" +"臭狗屎!", myStyle);
            }

            text90 = "\"" + "Smell pussy!" + "\"";
            if (text90b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text90 + "\n" +"臭脓样!", myStyle);
            }

            text91 = "\"" + "I taste little bit yeast in this..." + "\"";
            if (text91b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text91 + "\n" +"我尝了一点点酵母菌...", myStyle);
            }

            text92 = "\"" + "I taste some vinegar here... could be better." + "\"";
            if (text92b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text92 + "\n" +"我喜欢吃一些醋。可以更好。", myStyle);
            }

            text93 = "\"" + "Could be stronger for sure... little lame." + "\"";
            if (text93b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text93 + "\n" +"可以肯定更强。小瘸腿。", myStyle);
            }

            text94 = "\"" + "Let's see how good sugar wine this is..." + "\"";
            if (text94b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text94 + "\n" +"让我们看看这是多么好的糖酒...", myStyle);
            }

            text95 = "\"" + "This tastes nothing but yeast! This is shit, take it a away." + "\"";
            if (text95b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text95 + "\n" +"这只不过是酵母！这是狗屎，拿走它。", myStyle);
            }

            text96 = "\"" + "What the hell, this is like drinking pickels in piss! Take this shit out of here." + "\"";
            if (text96b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text96 + "\n" +"什么该死的，这就像是在小便里喝泡泡糖！把这狗屎从这里拿出来。", myStyle);
            }

            text97 = "\"" + "This tastes like water and piss, I want alcohol, not this mess..." + "\"";
            if (text97b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text97 + "\n" +"这味道像水和尿，我想要酒精，不是这个烂摊子...", myStyle);
            }

            text98 = "\"" + "This is drinkable... I can pay something for this." + "\"";
            if (text98b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text98 + "\n" +"这是可以喝的…我可以为此付出代价。", myStyle);
            }

            text99 = "\"" + "Very good sugar wine! I love this, strong as hell! I pay good for this." + "\"";
            if (text99b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text99 + "\n" +"非常好的糖酒！”我爱这个，像地狱一样坚强！我为此付出了很好的代价。", myStyle);
            }
            ...
            if (text100b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text100 + "\n" +"我试图给每个人打电话。请你从酒吧接我，开车送我回家好吗？", myStyle);
            }

            text101 = "\"" + "This is good, this here is my house, this here... house." + "\"";
            if (text101b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text101 + "\n" +"这是好的，这是我的房子，这里…房子", myStyle);
            }

            text102 = "\"" + "Here is a small compensation of your troubles." + "\"";
            if (text102b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text102 + "\n" +"这是麻烦你的一个小小的补偿。", myStyle);
            }

            text103 = "\"" + "My wife constantly reminds me of my drinking... But drinking is a job... for drunkman." + "\"";
            if (text103b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text103 + "\n" +"我妻子经常提醒我别喝酒。但是作为醉汉···喝酒是一项工作啊。", myStyle);
            }
            ...
            if (text104b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text104 + "\n" +"我的妻子打算搬到瓦萨，给自己找一个芬兰男人。" + "\n" + "那些是如此干净利落！30年婚姻要没了", myStyle);
            }

            text105 = "\"" + "That train is driving me crazy. It blows that whistle just to fuck with me. Every day!" + "\"";
            if (text105b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text105 + "\n" +"那辆火车快把我逼疯了。每一天，它的噪音就像要和我做爱！", myStyle);
            }

            text106 = "\"" + "One of these days I will run to the rail tracks and shout: Blow that whistle and run over me, sucker!" + "\"";
            if (text106b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text106 + "\n" +"有一天，我会跑到铁轨上大喊：吵死了，滚蛋，傻瓜！", myStyle);
            }

            text107 = "\"" + "You are wise boy... I need to tell you something. You know, nobody knows that I am very rich man. A millionaire..." + "\" ";
            if (text107b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text107 + "\n" +"你是个聪明的男孩…我需要告诉你一些事情。你知道，" + "\n" + "没人知道我是个非常有钱的人。百万富翁……", myStyle);
            }
            ...
            if (text108b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text108 + "\n" +"我需要像我现在的生活一样继续…我是最富有的酒鬼！" + "\n" + "至少我妻子和我在一起。不是和一些笨手笨脚的西红柿农场主。", myStyle);
            }

            text109 = "\"" + "My wife did not know she had a winning Lottery ticket. I took it and got the money myself... 5 million marks!" + "\"";
            if (text109b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text109 + "\n" +"我妻子不知道她有一张中奖的彩票。我自己拿了钱500万分！", myStyle);
            }
            ...
            if (text110b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text110 + "\n" +"我有一个隐藏在手提箱里的钱。但我不能用这笔钱，" + "\n" + "因为妻子会怀疑…如果她有钱，她就会离开我！", myStyle);
            }

            text111 = "\"" + "You little bastard! You have taken my money!" + "\"";
            if (text111b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text111 + "\n" +"你这个小杂种！”你拿走了我的钱！", myStyle);
            }

            text112 = "\"" + "What is the problem if money does not do it for you?" + "\"";
            if (text112b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text112 + "\n" +"如果钱不是为你拿的，那么是谁拿的？", myStyle);
            }

            text113 = "\"" + "Good evening! Thank you for coming!" + "\"";
            if (text113b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text113 + "\n" +"晚上好！谢谢您的光临！", myStyle);
            }

            text114 = "\"" + "Thank you and see you later!" + "\"";
            if (text114b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text114 + "\n" +"谢谢你，再见！", myStyle);
            }

            text115 = "\"" + "You are too poor for these purchases." + "\"";
            if (text115b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text115 + "\n" +"你太穷了就买这些.", myStyle);
            }

            text116 = "\"" + "Oh my god... Adult man peeing all over the place. My store is not a toilet." + "\"";
            if (text116b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text116 + "\n" +"哦，我的上帝……成年男子到处撒尿。我的商店不是厕所。", myStyle);
            }

            text117 = "\"" + "Well well... Good day for you too, glumpsy." + "\" ";
            if (text117b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text117 + "\n" +"嗯…祝你好运，glumpsy", myStyle);
            }

            text118 = "\"" + "Welcome to the Teim... Oh it's you." + "\"";
            if (text118b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text118 + "\n" +"欢迎来到TEIM…哦，是你。", myStyle);
            }

            text119 = "\"" + "I am about to close the store, so shake that booty little faster." + "\"";
            if (text119b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text119 + "\n" +"我快关店了，所以想要买东西的请快一点。", myStyle);
            }

            text120 = "\"" + "Did you know I used to be a wrestler? Not professional though." + "\"";
            if (text120b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text120 + "\n" +"你知道我曾经是个摔跤手吗？但不专业。", myStyle);
            }

            text121 = "\"" + "What and odd summer. It rains and then rain stops." + "\"";
            if (text121b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text121 + "\n" +"多么奇怪的夏天。雨来了又停了", myStyle);
            }

            text122 = "\"" + "Have you listened a radio lately? It is full of punks these days." + "\"";
            if (text122b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text122 + "\n" +"你最近听过收音机吗？这些日子里到处都说朋克", myStyle);
            }

            text123 = "\"" + "I used to be a quite a fisherman. Thats one thing I used to be." + "\"";
            if (text123b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text123 + "\n" +"我曾经是一个相当不错的渔夫。这是我曾经做过的一件事。", myStyle);
            }

            text124 = "\"" + "Tourists don't buy milk. They buy beer and milk goes sour. That's how it goes I guess." + "\"";
            if (text124b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text124 + "\n" +"游客不买牛奶。他们买啤酒，牛奶会变酸。我猜是这样的", myStyle);
            }

            text125 = "\"" + "I used to have a dog. Again one thing I used to have." + "\"";
            if (text125b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text125 + "\n" +"我过去有一只狗。还有一件事我曾经有过..", myStyle);
            }

            text126 = "\"" + "I can't understand today's music at all. Must be something that has been made for punks." + "\"";
            if (text126b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text126 + "\n" +"我根本听不懂今天的音乐。必须是为朋克制造的东西..", myStyle);
            }

            text127 = "\"" + "Marjattaaaaaaa...... You used to carry light to me..." + "\"";
            if (text127b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text127 + "\n" +"Marjattaaaaaaa……你曾经给我带着光……", myStyle);
            }

            text128 = "\"" + "Those little punks are buying all the sugar and yeast. Let them enjoy their farts, all I care." + "\"";
            if (text128b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text128 + "\n" +"那些小朋克正在购买所有的糖和酵母。让他们享受他们的屁，我只在乎", myStyle);
            }

            text129 = "\"" + "They say fuel price is high. I say, they haven't seen anything yet. It will cost more than milk one day." + "\"";
            if (text129b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text129 + "\n" +"他们说燃油价格高。我说，他们还没有看到任何东西。一天比牛奶还要贵。", myStyle);
            }

            text130 = "\"" + "This economic regression. It can get quite bad. I might need to discount sausage prices." + "\"";
            if (text130b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text130 + "\n" +"这种经济回归。可能会很糟糕。我可能需要打折香肠价格", myStyle);
            }

            text131 = "\"" + "Very beautiful finger you got there. Really, I am not kidding." + "\" ";
            if (text131b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text131 + "\n" +"非常漂亮的手指你到达那里。”真的，我不是开玩笑的。", myStyle);
            }

            text132 = "\"" + "Fuck off little punk." + "\"";
            if (text132b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text132 + "\n" +"操 小朋克", myStyle);
            }

            text133 = "\"" + "You know the green car that drives the backroads and never stops for gas? I think the car runs with alcohol." + "\"";
            if (text133b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text133 + "\n" +"你知道绿色汽车，后轮驱动，永不停止的排气" + "\n" + "我想这辆车是用酒精行驶的。", myStyle);
            }
            ...
            if (text134b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text134 + "\n" +"我不认为蚊子喷雾真的起作用。" + "\n" + "即使喷满后，这些小朋克也能四处飞翔。", myStyle);
            }

            text135 = "\"" + "Could you possibly pay with coins? I lost the key for the slot machine and I can't get the money out..." + "\"";
            if (text135b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text135 + "\n" +"你能用硬币支付吗？我把老虎机的钥匙丢了，我拿不到钱...", myStyle);
            }

            text136 = "\"" + "Those punks. Why do they keep calling me in the middle of the night? I have since unplugged my phone for the night." + "\"";
            if (text136b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text136 + "\n" +"那些朋克”。为什么他们一直在半夜给我打电话？从那以后我就拔出了我的手机", myStyle);
            }

            text137 = "\"" + "My washing machine is broken. I have only one pair of clean underwear... Oh... I mean I had... Well, shit happens." + "\"";
            if (text137b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text137 + "\n" +"我的洗衣机坏了。我只有一双干净的内衣…哦。。。我的意思是…嗯，狗屎发生了。", myStyle);
            }

            text138 = "\"" + "I am done with drinking. You know how my eyes are not focusing straight after I have drank some." + "\"";
            if (text138b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text138 + "\n" +"我喝完了。你知道我的眼睛是不是在我喝了一些东西之后一直不停地聚焦。", myStyle);
            }
            ...
            if (text139b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text139 + "\n" +"那么，你参加集会了吗？”有两个竞争者时，我一度位居第二。有时你活着出来。", myStyle);
            }

            text140 = "\"" + "Did you know that a small sticker representing country of Finland costs many hunderds of marks? That is insane." + "\"";
            if (text140b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text140 + "\n" +"你知道一个代表芬兰国家的小贴纸要花很多马克吗？那是疯狂的。", myStyle);
            }

            text141 = "\"" + "Throw yourself up on to the hill, you little punk." + "\"";
            if (text141b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text141 + "\n" +"把你自己扔到山上，你这个小朋克。", myStyle);
            }

            text142 = "\"" + "Hey you little drunk punk, do not lean on to the shelf and mess up my store. I hate drunk cretins." + "\"";
            if (text142b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text142 + "\n" +"嘿，你这个小酒鬼，不要趴在架子上弄乱我的商店。”我讨厌醉鬼。", myStyle);
            }

            text143 = "\"" + "No no no... Why are you peeing there? Adult man, you little punk!" + "\"";
            if (text143b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text143 + "\n" +"不不不。你为什么在那儿撒尿？大人，你这个小混蛋！", myStyle);
            }

            text144 = "\"" + "What...? You damn punk, now get the hell out of here. Peeing all over the place!" + "\"";
            if (text144b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text144 + "\n" +"什么？你这个该死的朋克，现在滚开。到处撒尿！", myStyle);
            }

            text145 = "\"" + "I know you've stolen fuel. Come back and pay!" + "\"";
            if (text145b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text145 + "\n" +"我知道你偷了燃料。回来付钱！", myStyle);
            }

            text146 = "\"" + "Hello!" + "\"";
            if (text146b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text146 + "\n" +"你好!", myStyle);
            }

            text147 = "\"" + "Good day!" + "\"";
            if (text147b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text147 + "\n" +"好日子!", myStyle);
            }

            text148 = "\"" + "Thank you for visiting!" + "\"";
            if (text148b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text148 + "\n" +"谢谢你的来访!", myStyle);
            }

            text149 = "\"" + "Hey to the dishes and dishes to the dish washer!" + "\"";
            if (text149b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text149 + "\n" +"嘿，菜和菜到洗碗机!", myStyle);
            }

            text150 = "\"" + "Well good day, what brings you to the city?" + "\"";
            if (text150b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text150 + "\n" +"好的一天，是什么把你带到城市的？", myStyle);
            }

            text151 = "\"" + "508... 509... Well hello! What can I do for you?" + "\"";
            if (text151b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text151 + "\n" +"508…509…你好！我能为您做点什么？", myStyle);
            }

            text152 = "\"" + "Thank you and so long!" + "\"";
            if (text152b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text152 + "\n" +"谢谢你，这么久！", myStyle);
            }

            text153 = "\"" + "We'll see again!" + "\"";
            if (text153b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text153 + "\n" +"我们再看一遍！", myStyle);
            }

            text154 = "\"" + "Thank you for business co-operation!" + "\"";
            if (text154b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text154 + "\n" +"谢谢您的业务合作！", myStyle);
            }

            text155 = "\"" + "Thank you very much and have nice day!" + "\"";
            if (text155b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text155 + "\n" +"非常感谢你，祝你有美好的一天！", myStyle);
            }

            text156 = "\"" + "Wha... I... Th... Piss... Yo... Damn punk peeing... Oh my god what is this, you get out of here now!" + "\"";
            if (text156b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text156 + "\n" +"WHA…I.…钍…撒尿…哟。。。该死的朋克嘘声…哦，天哪，这是什么，你现在离开这里！", myStyle);
            }

            text157 = "\"" + "For such young punk, you are quite a man when it comes to drinking." + "\"";
            if (text157b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text157 + "\n" +"对于这样一个年轻的朋克，当你喝酒的时候，你是个相当不错的人。", myStyle);
            }

            text158 = "\"" + "How about one bottle of Noble booze and asbestos gloves, or tall friends?" + "\"";
            if (text158b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text158 + "\n" +"一瓶高贵的酒和石棉手套，还是高的朋友？", myStyle);
            }

            text159 = "\"" + "What would you like? Golden brown Nivalan Kalia together with horrible day after ramifications?" + "\"";
            if (text159b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text159 + "\n" +"你想要什么？Golden brown Nivalan Kalia together with horrible day after ramifications？", myStyle);
            }

            text160 = "\"" + "Today we have a special offer! If you buy one beer, you are able to buy second beer as well!" + "\"";
            if (text160b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text160 + "\n" +"今天我们有一个特别优惠！如果你买一杯啤酒，你也能买到第二杯啤酒！", myStyle);
            }

            text161 = "\"" + "So, you too are here to make your brains forgot how depressing is our life in here?" + "\"";
            if (text161b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text161 + "\n" +"所以，你也在这里让你的大脑忘记我们这里的生活有多么压抑吗？", myStyle);
            }

            text162 = "\"" + "Hey punk! You are going to pay for that!" + "\"";
            if (text162b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text162 + "\n" +"嘿朋克！你会为此付出代价的！", myStyle);
            }

            text163 = "\"" + "So... How much can you absorb alcohol?" + "\"";
            if (text163b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text163 + "\n" +"所以…你能吸收多少酒精？", myStyle);
            }

            text164 = "\"" + "Should you stop the drinking now that you are still able to stand?" + "\"";
            if (text164b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text164 + "\n" +"如果你还可以站立，你应该停止喝酒吗？", myStyle);
            }

            text165 = "\"" + "Just go for it and shatter your life!" + "\"";
            if (text165b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text165 + "\n" +"只为它，粉碎你的生命!", myStyle);
            }

            text166 = "\"" + "I assume this is your last drink, right?" + "\"";
            if (text166b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text166 + "\n" +"我想这是你最后一杯饮料，对吧?", myStyle);
            }

            text167 = "\"" + "I hate these flies and mosquitos. Buzzing.... These suckers are pissing me off!" + "\"";
            if (text167b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text167 + "\n" +"我讨厌这些苍蝇和蚊子。嗡嗡声…这些吸食鬼把我惹火了！", myStyle);
            }

            text168 = "\"" + "If you have problem with this, you can go to another store. But oh... you can't. He he" + "\"";
            if (text168b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text168 + "\n" +"如果你有这个问题，你可以去另一个商店。但是哦…你不能。他.", myStyle);
            }

            text169 = "\"" + "Is this your birthday or what sort of festival are you having?" + "\"";
            if (text169b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text169 + "\n" +"这是你的生日或是什么节日？", myStyle);
            }

            text170 = "\"" + "Yeah yeah, and now add some butter in between." + "\"";
            if (text170b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text170 + "\n" +"是的，是的，现在在中间加一些黄油", myStyle);
            }

            text171 = "\"" + "I wonder if I am committing a crime here, serving you." + "\"";
            if (text171b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text171 + "\n" +"我想知道我是否在这里犯罪，为你服务？", myStyle);
            }

            text172 = "\"" + "Sooo.. It seems like you are starting to drink for the third leg as well." + "\"";
            if (text172b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text172 + "\n" +"SOOO。看来你也开始为第三条腿喝水了", myStyle);
            }

            text173 = "\"" + "There seems to be no point with your drinking..." + "\"";
            if (text173b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text173 + "\n" +"你的饮酒似乎没有任何意义…", myStyle);
            }

            text174 = "\"" + "I wonder whether I should enlarge the corridors here because the wide dance moves of yours." + "\"";
            if (text174b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text174 + "\n" +"我不知道我是否应该扩大这里的走廊，因为你的舞蹈动作很宽。", myStyle);
            }

            text175 = "\"" + "Well look at the kid. You are such bottomless pit, I must say." + "\"";
            if (text175b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text175 + "\n" +"看孩子。”我必须说，你是个无底洞。", myStyle);
            }

            text176 = "\"" + "This is what human relationships are, you live with it." + "\"";
            if (text176b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text176 + "\n" +"这就是人类的关系，你和它一起生活。", myStyle);
            }

            text177 = "\"" + "It is our own boy, human waste transport guy! Stop smelling like shit and go to hell." + "\"";
            if (text177b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text177 + "\n" +"它是我们自己的男孩，人类浪费运输的家伙！”停止闻狗屎，然后去地狱。", myStyle);
            }

            text178 = "\"" + "You don't have better things to do but smell bad? There is piss already everywhere, now it smells like shit too." + "\"";
            if (text178b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text178 + "\n" +"你没有更好的事情做，但气味不好？到处都有尿，现在闻起来像狗屎。", myStyle);
            }

            text179 = "\"" + "Oh boy... Even the most famous cuckoo would say that, you sir, are drunk." + "\"";
            if (text179b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text179 + "\n" +"哦男孩”即使是最有名的杜鹃也会说，先生，你喝醉了。", myStyle);
            }

            text180 = "\"" + "And drunk again? Please do not puke inside the frozen fish fridge, like that one occasion." + "\"";
            if (text180b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text180 + "\n" +"然后又喝醉了吗？请不要在冷冻鱼冰箱里呕吐，就像那个场合。", myStyle);
            }

            text181 = "\"" + "Stop dancing with your fist female. I will smack your face and you fly like a wooden javelin!" + "\"";
            if (text181b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text181 + "\n" +"停止与拳头女性跳舞。我会打你的脸，你像木头标枪一样飞！", myStyle);
            }

            text182 = "\"" + "I am president of Finland." + "\"";
            if (text182b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text182 + "\n" +"我是芬兰总统", myStyle);
            }

            text183 = "\"" + "There is first lady." + "\"";
            if (text183b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text183 + "\n" +"有第一夫人", myStyle);
            }

            text184 = "\"" + "So, this is the way I am a president all along." + "\"";
            if (text184b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text184 + "\n" +"所以，这就是我一直是总统的方式。.", myStyle);
            }

            text185 = "\"" + "From the president jail, to here to countryside." + "\"";
            if (text185b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text185 + "\n" +"从总统监狱，到这里到农村.", myStyle);
            }

            text186 = "\"" + "My drivers name is Cadet Tenho." + "\"";
            if (text186b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text186 + "\n" +"我的司机名字是Cadet Tenho.", myStyle);
            }

            text187 = "\"" + "Of course not! I am a president." + "\"";
            if (text187b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text187 + "\n" +"当然不是！我是总统。", myStyle);
            }

            text188 = "\"" + "He? I haven't even heard about it." + "\"";
            if (text188b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text188 + "\n" +"他？我还没有听说过", myStyle);
            }

            text189 = "\"" + "My personal assistant is mr. Wood-Field-Forest." + "\"";
            if (text189b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text189 + "\n" +"我的私人助理是Wood-Field-Forest.。", myStyle);
            }

            text190 = "\"" + "Well after all, I am a president." + "\"";
            if (text190b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text190 + "\n" +"毕竟，我是一个总统", myStyle);
            }

            text191 = "\"" + "See, a birch. Flowery rose." + "\"";
            if (text191b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text191 + "\n" +"看，桦树。玫瑰花", myStyle);
            }

            text192 = "\"" + "It is hard as a wet bedrock." + "\"";
            if (text192b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text192 + "\n" +"它是一个硬的湿基岩.", myStyle);
            }

            text193 = "\"" + "Well I am a president." + "\"";
            if (text193b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text193 + "\n" +"我是总统.", myStyle);
            }

            text194 = "\"" + "The first lady is quite thin person." + "\"";
            if (text194b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text194 + "\n" +"第一夫人是相当瘦的人.", myStyle);
            }

            text195 = "\"" + "When president was a carpenter, wife was still young. So does the profession make us old." + "\"";
            if (text195b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text195 + "\n" +"当总统是木匠时，妻子还年轻。工作也使我们变老了.", myStyle);
            }

            text196 = "\"" + "Change is welcomed. I used to sit in jail all the time." + "\"";
            if (text196b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text196 + "\n" +"改变是受欢迎的。我过去总是坐在监狱里.", myStyle);
            }

            text197 = "\"" + "I was not in Alcatraz, but in presidential jail." + "\"";
            if (text197b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text197 + "\n" +"我不在恶魔岛，而是在总统监狱里.", myStyle);
            }

            text198 = "\"" + "So after all, I am a president." + "\"";
            if (text198b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text198 + "\n" +"所以毕竟，我是总统.", myStyle);
            }

            text199 = "\"" + "Listen, officer. I am a president." + "\"";
            if (text199b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text199 + "\n" +"听着。我是总统.", myStyle);
            }

            text200 = "\"" + "I could fire you at any moment, officer." + "\"";
            if (text200b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text200 + "\n" +"我随时可以开火，警官。", myStyle);
            }

            text201 = "\"" + "I am a president, after all." + "\"";
            if (text201b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text201 + "\n" +"我毕竟是总统.", myStyle);
            }

            text202 = "\"" + "I am not drunk, and not in St Michel, I am here." + "\"";
            if (text202b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text202 + "\n" +"我没有醉，而不是在圣米歇尔，我在这里.", myStyle);
            }

            text203 = "\"" + "I haven't had a single drink." + "\"";
            if (text203b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text203 + "\n" +"“我没有喝过一杯.", myStyle);
            }

            text204 = "\"" + "I am the president." + "\"";
            if (text204b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text204 + "\n" +"我是总统.", myStyle);
            }

            text205 = "\"" + "I am first president of Finland who has his pants upside down." + "\"";
            if (text205b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text205 + "\n" +"我是芬兰的第一任总统，他的裤子上下颠倒.", myStyle);
            }

            text206 = "\"" + "My watch shows the correct time of Finnish republic." + "\"";
            if (text206b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text206 + "\n" +"我的表显示芬兰共和国的正确时间。.", myStyle);
            }

            text207 = "\"" + "I am police officer." + "\"";
            if (text207b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text207 + "\n" +"我是警官.", myStyle);
            }

            text208 = "\"" + "I am here to check drunk state of potato president." + "\"";
            if (text208b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text208 + "\n" +"我在这里检查土豆总统的醉状态.", myStyle);
            }

            text209 = "\"" + "I know you are not coming from a jail." + "\"";
            if (text209b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text209 + "\n" +"我知道你不是从监狱来的.", myStyle);
            }

            text210 = "\"" + "Not like Alcatraz, but presidential jail." + "\"";
            if (text210b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text210 + "\n" +"不象恶魔岛，而是总统监狱", myStyle);
            }

            text211 = "\"" + "I am police officer, after all." + "\"";
            if (text211b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text211 + "\n" +"我是警官，毕竟，", myStyle);
            }

            text212 = "\"" + "Mr. President." + "\"";
            if (text212b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text212 + "\n" +"总统先生.", myStyle);
            }

            text213 = "\"" + "You can't go here." + "\"";
            if (text213b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text213 + "\n" +"你不能到这里", myStyle);
            }

            text214 = "\"" + "Because of my rights." + "\"";
            if (text214b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text214 + "\n" +"因为我的权利", myStyle);
            }

            text215 = "\"" + "I cannot deliver you." + "\"";
            if (text215b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text215 + "\n" +"我不能递送你.", myStyle);
            }

            text216 = "\"" + "In to jail." + "\"";
            if (text216b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text216 + "\n" +"在监狱中.", myStyle);
            }

            text217 = "\"" + "Because." + "\"";
            if (text217b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text217 + "\n" +"因为.", myStyle);
            }

            text218 = "\"" + "Because you are... of Finland." + "\"";
            if (text218b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text218 + "\n" +"因为你是…芬兰的.", myStyle);
            }

            text219 = "\"" + "President." + "\"";
            if (text219b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text219 + "\n" +"总统.", myStyle);
            }

            text220 = "\"" + "The first lady." + "\"";
            if (text220b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text220 + "\n" +"第一夫人.", myStyle);
            }

            text221 = "\"" + "It truly looks like." + "\"";
            if (text221b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text221 + "\n" +"它看起来像", myStyle);
            }

            text222 = "\"" + "That...'" + "\"";
            if (text222b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text222 + "\n" +"那个...", myStyle);
            }

            text223 = "\"" + "Looks like a bad shape to me." + "\"";
            if (text223b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text223 + "\n" +"看起来像是一个坏的形状.", myStyle);
            }

            text224 = "\"" + "Finnish president of Zanzibar of Africa." + "\"";
            if (text224b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text224 + "\n" +"芬兰桑给巴尔总统”.", myStyle);
            }

            text225 = "\"" + "To the moment." + "\"";
            if (text225b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text225 + "\n" +"到此刻", myStyle);
            }

            text226 = "\"" + "You are." + "\"";
            if (text226b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text226 + "\n" +"你是.", myStyle);
            }

            text227 = "\"" + "Right here, right now." + "\"";
            if (text227b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text227 + "\n" +"在这里，现在.", myStyle);
            }

            text228 = "\"" + "At this time." + "\"";
            if (text228b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text228 + "\n" +"此时.", myStyle);
            }

            text229 = "\"" + "About here." + "\"";
            if (text229b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text229 + "\n" +"在这里.", myStyle);
            }

            text230 = "\"" + "For this." + "\"";
            if (text230b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text230 + "\n" +"为此.", myStyle);
            }

            text231 = "\"" + "I am a officer... ding dong." + "\"";
            if (text231b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text231 + "\n" +"我是一名军官… ding dong.", myStyle);
            }

            text232 = "\"" + "I guarantee your safety." + "\"";
            if (text232b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text232 + "\n" +"我保证您的安全.", myStyle);
            }

            text233 = "\"" + "That is not what I said." + "\"";
            if (text233b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text233 + "\n" +"那不是我所说的", myStyle);
            }

            text234 = "\"" + "Well I am just a human, as you can see." + "\"";
            if (text234b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text234 + "\n" +"正如你所见，我只是一个人", myStyle);
            }

            text235 = "\"" + "I salute your wife, Mr. President." + "\"";
            if (text235b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text235 + "\n" +"总统先生，我向您的妻子致敬.", myStyle);
            }

            text236 = "\"" + "Party? I don't want to." + "\"";
            if (text236b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text236 + "\n" +"党？我不想", myStyle);
            }

            text237 = "\"" + "But, I do not accept." + "\"";
            if (text237b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text237 + "\n" +"但是，我不接受", myStyle);
            }

            text238 = "\"" + "You are drunk." + "\"";
            if (text238b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text238 + "\n" +"你喝醉了.", myStyle);
            }

            text239 = "\"" + "Yes?" + "\"";
            if (text239b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text239 + "\n" +"是?", myStyle);
            }

            text240 = "\"" + "Good day, good day! Here have some coffee." + "\"";
            if (text240b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text240 + "\n" +"好日子，好日子！这里有一些咖啡!", myStyle);
            }

            text241 = "\"" + "Your dad is quite sober man. I thought he would start drinking after being rejected from 1972 Olympics." + "\"";
            if (text241b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text241 + "\n" +"你父亲是个相当清醒的人。我想他会在1972奥运会被拒绝后开始喝酒。", myStyle);
            }
            ...
            if (text242b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text242 + "\n" +"可能是酒精基因进入你。远离饮酒！" + "\n" + "看看你叔叔。我希望他没事", myStyle);
            }

            text243 = "\"" + "Like Valto your granddad. After he came from war he was different man. No talking, no kissing. Only drinking." + "\"";
            if (text243b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text243 + "\n" +"就像Valto，你的爷爷。他出战后是个与众不同的人。" + "\n" + "不说话，不接吻。只有喝酒。", myStyle);
            }
            ...
            if (text244b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text244 + "\n" +"战争对于那些年轻男孩来说是很难的。" + "\n" + "但Valto回来建造了这所房子，然后在喝酒前把那些田地建起来。", myStyle);
            }

            text245 = "\"" + "And here is little money for you. I know you need it." + "\"";
            if (text245b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text245 + "\n" +"这是给你的一点钱。我知道你需要它。", myStyle);
            }
            ...
            if (text246b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text246 + "\n" +"只是一个警告，不要搭一辆绿色车。同一家人喝酒的问题，总是醉醺醺的。.", myStyle);
            }

            text247 = "\"" + "One day I was picking up mail, and almost got run over by him! Happy and drunk he was. Don't go with him." + "\"";
            if (text247b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text247 + "\n" +"有一天我捡起邮件，差点被他撞倒！他醉醺醺的。不要和他一起去。", myStyle);
            }
            ...
            if (text248b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text248 + "\n" +"你有未来的计划吗？你住在这里吗？没有理由搬到城市去，在那里你只会发现愚蠢。", myStyle);
            }
            ...
            if (text249b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text249 + "\n" +"也没有作业。他们只是说，很多人申请同样的工作！你应该呆在这儿找个老婆。", myStyle);
            }
            ...
            if (text250b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text250 + "\n" +"你有工作吗？这里的工作不多。当你父母不在家的时候，你正在照看房子。", myStyle);
            }
            ...
            if (text251b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text251 + "\n" +"你叔叔可能也有东西给你。我不知道他在哪里…当他喝酒时，他通常会消失很长时间。", myStyle);
            }

            text252 = "\"" + "What is it with the young people at the store. Playing that thumping music out loud." + "\"";
            if (text252b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text252 + "\n" +"与商店里的年轻人有什么关系？”大声地演奏那砰砰的音乐。", myStyle);
            }
            ...
            if (text253b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text253 + "\n" +"和语言。听他们谈话时，我看到各种各样的生殖器！这几天我不能逛商店了。", myStyle);
            }
            ...
            if (text254b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text254 + "\n" +"你的父母什么时候度假回来？我想知道芬兰的夏天是不够的。", myStyle);
            }
            ...
            if (text255b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text255 + "\n" +"我在芬兰度过了78个夏天，从不需要去国外一些愚蠢的地方旅行。." + "\n" + "我想，你的父母一直都是这样活跃的人.", myStyle);
            }
            ...
            if (text256b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text256 + "\n" +"我想知道Teimo的动机是如何保持商店的开放。所有的大市场和所有这些日子。人们不再喜欢当地的小商店了。", myStyle);
            }
            ...
            if (text257b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text257 + "\n" +"人越来越老，腿又坏了……也许商店旁边的餐馆为Teimo赚到足够的收入", myStyle);
            }

            text258 = "\"" + "Hear this warning. Do not go to play cards to that lake side cabin. I've heard this story and it is true story." + "\"";
            if (text258b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text258 + "\n" +"听到这个警告。不要去湖边小屋玩扑克牌。我听过这个故事，这是真实的故事。", myStyle);
            }

            text259 = "\"" + "And I say this. Do not play with matches. Not one time that families have lost their homes." + "\"";
            if (text259b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text259 + "\n" +"我这样说。不要玩火柴。没有一次家庭失去家园。", myStyle);
            }

            text260 = "\"" + "What is it there that we don't have here? You really should find yourself a wife." + "\"";
            if (text260b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text260 + "\n" +"我们这里没有什么？”你真的应该找到自己的妻子。", myStyle);
            }

            text261 = "\"" + "Great job hey! There is still some good people left! Here is some compensation for your troubles." + "\"";
            if (text261b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text261 + "\n" +"伟大的工作嘿！还有一些好人离开了！这是对你的麻烦的补偿。", myStyle);
            }

            text262 = "\"" + "I almost forgot that I need to pay to you as well, damn." + "\"";
            if (text262b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text262 + "\n" +"我几乎忘记了我还需要支付给你，该死的", myStyle);
            }

            text263 = "\"" + "Getting bored already? Well, have some little candy money." + "\"";
            if (text263b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text263 + "\n" +"已经厌倦了吗？”好吧，吃点糖果吧.", myStyle);
            }

            text264 = "\"" + "Hello there." + "\"";
            if (text264b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text264 + "\n" +"你好.", myStyle);
            }

            text265 = "\"" + "So so..." + "\"";
            if (text265b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text265 + "\n" +"So so...", myStyle);
            }

            text266 = "\"" + "So... Lets see how much it costs... Hmm, yeah... Well yeah." + "\"";
            if (text266b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text266 + "\n" +"所以…让我们看看它花了多少钱…嗯，是的…嗯，是的.", myStyle);
            }

            text267 = "\"" + "Just back up your truck through the garage doors. Then empty your tank at the grate on floor." + "\"";
            if (text267b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text267 + "\n" +"就回来了，哟，车通过你的车库门。然后在对空坦克的grate地板”", myStyle);
            }

            text268 = "\"" + "Every single day full of shit." + "\"";
            if (text268b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text268 + "\n" +"每一个单一的一天充满了屎。", myStyle);
            }

            text269 = "\"" + "Yep, yeah." + "\"";
            if (text269b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text269 + "\n" +"是的，是的", myStyle);
            }

            text270 = "\"" + "So, this kind of case here." + "\"";
            if (text270b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text270 + "\n" +"相比，这种情况在这里.", myStyle);
            }

            text271 = "\"" + "At least shit cant turn into any worse. Heh heh." + "\"";
            if (text271b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text271 + "\n" +"至少cant变成任何糟糕变得更糟。嘿嘿嘿.", myStyle);
            }

            text272 = "\"" + "If shit were gold, I would be a rich man. But it is not. Heh heh." + "\"";
            if (text272b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text272 + "\n" +"如果大便是金，我将是一个丰富的人。但它不是。嘿嘿嘿.", myStyle);
            }

            text273 = "\"" + "To me equality means that every single persons rear end produces crap." + "\"";
            if (text273b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text273 + "\n" +"我的每一个单一的平等意味着结束生产后患者废话", myStyle);
            }

            text274 = "\"" + "I just wanted to say that this is shitty job. Not as shitty as yours, but almost." + "\"";
            if (text274b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text274 + "\n" +"我只是想说，这是shitty工作。你shitty为不作为，但几乎", myStyle);
            }

            text275 = "\"" + "No no no... Bring only completely full boxes!" + "\"";
            if (text275b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text275 + "\n" +"没有没有没有……只有完全完整的带盒", myStyle);
            }

            text276 = "\"" + "Thank you so much! Hey if you still have that Kilju I am always buying for more!" + "\"";
            if (text276b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text276 + "\n" +"非常感谢你！嘿，如果你仍然有，吉州郡这里总是买更多!", myStyle);
            }

            text277 = "\"" + "You have sold me shit, you little bastard! Smell pussy!" + "\"";
            if (text277b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text277 + "\n" +"你有sold我该死，你的小混蛋！女人的气息!", myStyle);
            }

            text278 = "\"" + "Is that music or what is it? Just thumping away. There is no slightest sense in that!" + "\"";
            if (text278b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text278 + "\n" +"是音乐或是什么，它？只是thumping离开。有没有slightest意义在那!", myStyle);
            }

            text279 = "\"" + "Young people these days... They should go to work! Thumping away in middle of the town. There is even church there!" + "\"";
            if (text279b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text279 + "\n" +"年轻人这些天…他们应该去工作！在中间的thumping离开该镇。甚至教堂也有!", myStyle);
            }
            ...
            if (text280b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text280 + "\n" +"这件事很长时间以前饰演的卡和他的爸爸。他的爸爸和这件事有比赢得了他的爸爸" + "\n" + "他愤怒的诅咒。然后他的爸爸死在房子火", myStyle);
            }

            text281 = "\"" + "And the thing is not a human! He even has claws like a pig. Never go there to play cards!" + "\" ";
            if (text281b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text281 + "\n" +"和这件事是不是一个人类！他甚至有爪的像猪。永远的走有发挥卡!", myStyle);
            }
            ...
            if (text282b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text282 + "\n" +"我记得那被烧毁的牛舍。孩子们在玩火柴，它很快就掉下来了。" + "\n" + "那些痛苦的尖叫着的牛。那些火柴不是给孩子们吃的!", myStyle);
            }

            text283 = "\"" + "Hey this here is my new apartment. Look at the view!" + "\"";
            if (text283b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text283 + "\n" +"这是我的新公寓。看风景!", myStyle);
            }

            text284 = "\"" + "Let's do so that you carry all the stuff inside and I wait. I will pay of course!" + "\"";
            if (text284b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text284 + "\n" +"让我们这样做，你把所有的东西里面，我等待。当然，我会付钱的!", myStyle);
            }

            text285 = "\"" + "Damn it will be dark before this field is done!" + "\"";
            if (text285b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text285 + "\n" +"该死的，在这个领域完成之前将是黑暗的!", myStyle);
            }

            text286 = "\"" + "Damn those strawberries will go rotten before you finish that job!" + "\"";
            if (text286b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text286 + "\n" +"在你完成那份工作之前，那些草莓会腐烂的!", myStyle);
            }

            text287 = "\"" + "Damn, my mother who had fatality would have picked four boxes in same time you pick one!" + "\"";
            if (text287b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text287 + "\n" +"该死，我的母亲谁有致命性将挑选了四个盒子在同一时间，你挑选一个!", myStyle);
            }

            text288 = "\"" + "I haven't slept for three weeks because of night frost warning! Damn strawberries going bad!" + "\"";
            if (text288b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text288 + "\n" +"因为夜间霜冻警告，我已经三个星期没有睡觉了！该死的草莓坏了!", myStyle);
            }

            text289 = "\"" + "Money dishes! Good thing I can pay in dark without you having to pay taxes!" + "\"";
            if (text289b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text289 + "\n" +"钱碟！好东西，我可以在黑暗中支付而不必纳税!", myStyle);
            }

            text290 = "\"" + "My wife left me. I bought a apartment with nice lakeview. Could you come by and help me with moving my stuff?" + "\"";
            if (text290b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text290 + "\n" +"我妻子离开了我。我买了一套漂亮的湖景公寓。你能过来帮我搬一下东西吗？", myStyle);
            }

            text291 = "\"" + "Young girls don't like it here unless they get married and have children. What does the city life offer?" + "\"";
            if (text291b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text291 + "\n" +"除非她们结婚生子，否则年轻女孩不喜欢这里。城市生活提供了什么?", myStyle);
            }

            text292 = "\"" + "Funny thing, I was lifting a TV set and somehow my back snapped... I guess you could carry all this?" + "\"";
            if (text292b)
            {
                GUI.Label(new Rect(0, (Screen.height) / 2.35f, Screen.width, Screen.height), text292 + "\n" +"有趣”的东西，我举着一台电视机，不知为什么我的背断了……我猜你能承担所有这些责任吗？", myStyle);
            }

            text293 = "\"" + "So do you already have a girl in mind? You should look for one before they move to the city."+ "\"";
            if (text293b)
            {
                 GUI.Label(new Rect(0, (Screen.height)/2.35f, Screen.width, Screen.height), text293 + "\n" +"那么你是否已经想到了一个女孩？你应该在他们搬到城市之前找一个。", myStyle);
            }
        }
